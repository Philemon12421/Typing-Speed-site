...
export const AnimatedGuideView: React.FC<AnimatedGuideViewProps> = ({
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      content: (
        <article className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-zinc-300 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">1. Eliminate the Cognitive Hesitation Buffer</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">2. The 98% Accuracy Golden Mandate</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">3. Master Burst Sprints vs. High-Stamina Endurance</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">4. Target Weak Digraphs with Error Heatmaps</h3>
          <p>
          ...
          <div className="p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/60 text-indigo-900 dark:text-indigo-200 text-sm font-semibold my-4">
    ...
    },
    {
      ...
      content: (
        <article className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-zinc-300 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">Why Looking at Keycaps Drastically Slows You Down</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">Home Row Spatial Anchoring</h3>
          <p>
    ...
    },
    {
      ...
      content: (
        <article className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-zinc-300 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100 border-b pb-2 border-slate-200 dark:border-zinc-800">Essential Ergonomic Principles</h3>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-zinc-300 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
              <h4 className="font-extrabold text-indigo-700 dark:text-indigo-400 text-sm">Linear Switches (Red / Yellow)</h4>
              <p className="text-xs text-slate-600 dark:text-zinc-400 mt-1">Smooth, continuous downward travel with no tactile resistance. Favored by rapid double-tappers and gaming enthusiasts.</p>
            </div>
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
              <h4 className="font-extrabold text-emerald-700 dark:text-emerald-400 text-sm">Tactile Switches (Brown / Panda)</h4>
              <p className="text-xs text-slate-600 dark:text-zinc-400 mt-1">Features a subtle bump right at the electrical actuation point. Widely considered the gold standard for accurate touch typing.</p>
            </div>
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
              <h4 className="font-extrabold text-amber-700 dark:text-amber-400 text-sm">Clicky Switches (Blue / Green)</h4>
              <p className="text-xs text-slate-600 dark:text-zinc-400 mt-1">Produces a crisp acoustic click upon actuation. Excellent for rhythm building, though higher operating force can induce finger fatigue.</p>
            </div>
          </div>
        </article>
      ),
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-zinc-300 leading-relaxed">
          ...
          <div className="overflow-x-auto my-6">
            <table className="w-full text-left border-collapse text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-slate-300 dark:border-zinc-800 bg-slate-100 dark:bg-zinc-900 text-slate-900 dark:text-zinc-100 font-bold">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-zinc-800">
                <tr><td className="p-3 font-bold text-slate-600 dark:text-zinc-400">0 - 30 WPM</td><td className="p-3 text-slate-700 dark:text-zinc-300">Beginner</td><td className="p-3 text-slate-700 dark:text-zinc-300">Bottom 20%</td><td className="p-3 text-slate-700 dark:text-zinc-300">Casual Users</td></tr>
                <tr><td className="p-3 font-bold text-sky-600 dark:text-sky-400">30 - 50 WPM</td><td className="p-3 text-slate-700 dark:text-zinc-300">Average</td><td className="p-3 text-slate-700 dark:text-zinc-300">50th Percentile</td><td className="p-3 text-slate-700 dark:text-zinc-300">General Office & Admin</td></tr>
                <tr><td className="p-3 font-bold text-indigo-600 dark:text-indigo-400">50 - 80 WPM</td><td className="p-3 text-slate-700 dark:text-zinc-300">Above Average</td><td className="p-3 text-slate-700 dark:text-zinc-300">80th Percentile</td><td className="p-3 text-slate-700 dark:text-zinc-300">Software Developers, Writers</td></tr>
                <tr><td className="p-3 font-bold text-purple-600 dark:text-purple-400">80 - 100 WPM</td><td className="p-3 text-slate-700 dark:text-zinc-300">Professional Master</td><td className="p-3 text-slate-700 dark:text-zinc-300">95th Percentile</td><td className="p-3 text-slate-700 dark:text-zinc-300">Journalists, Editors, Paralegals</td></tr>
                <tr><td className="p-3 font-bold text-amber-600 dark:text-amber-400">100+ WPM</td><td className="p-3 text-slate-700 dark:text-zinc-300">Elite / Grandmaster</td><td className="p-3 text-slate-700 dark:text-zinc-300">Top 1%</td><td className="p-3 text-slate-700 dark:text-zinc-300">Court Stenographers, Speed Typists</td></tr>
              </tbody>
            </table>
          </div>
        </article>
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 p-4 sm:p-8 animate-in fade-in duration-300">
      ...
      {/* Navigation Sub-Tabs */}
      <div className="flex items-center gap-1.5 border-b border-slate-200 dark:border-zinc-800 pb-2 overflow-x-auto scrollbar-none">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3.5 py-2 rounded-2xl font-extrabold text-xs sm:text-sm transition-all whitespace-nowrap ${
              mainTab === item.id
                ...
                : 'bg-white/70 dark:bg-black text-slate-600 dark:text-zinc-400 hover:bg-white dark:hover:bg-zinc-900 border border-slate-200/60 dark:border-zinc-800'
            }`}
          >
            {item.icon}
      ...
      {mainTab === 'blog' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-white/80 dark:bg-black border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-500 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border cursor-pointer transition-all flex flex-col gap-2 ${
                      isSelected
                        ...
                        : 'bg-white/70 dark:bg-black hover:bg-white dark:hover:bg-zinc-900 text-slate-700 dark:text-zinc-300 border-slate-200/60 dark:border-zinc-800'
                    }`}
                  >
                    <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider">
                      <span className={isSelected ? 'text-indigo-200' : 'text-indigo-600 dark:text-indigo-400'}>{post.category}</span>
                      <span className={isSelected ? 'text-indigo-200' : 'text-slate-400 dark:text-zinc-500'}>{post.readTime}</span>
                    </div>
          ...
          <div className="lg:col-span-8 p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-6">
            <header className="border-b border-slate-200 dark:border-zinc-800 pb-4">
              <div className="flex flex-wrap items-center gap-3 text-xs font-bold text-slate-500 dark:text-zinc-400 mb-2">
                <span className="px-2.5 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-800/50">{currentArticle.category}</span>
              ...
              <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-zinc-100 leading-tight">{currentArticle.title}</h1>
            </header>
      ...
      {mainTab === 'manual' && (
        <div className="flex flex-col gap-6">
          ...
          <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm min-h-[350px]">
            {activeManualTab === 'finger' && (
              <div className="flex flex-col gap-6">
                <div>
                  <span className="text-xs font-bold uppercase text-indigo-600 dark:text-indigo-400">Home Row Mapping</span>
                  <h2 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100">10-Finger Placement Ergonomics</h2>
                  <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 mt-1">Rest your fingers on ASDF and JKL;. Each finger is assigned specific column zones to minimize movement.</p>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex flex-col gap-2">
                      <div className="flex items-center gap-2">
                        <span className={`w-3 h-3 rounded-full ${f.color}`} />
                        <span className="font-extrabold text-xs text-slate-900 dark:text-zinc-100">{f.finger}</span>
                      </div>
                      <span className="text-[11px] font-medium text-slate-600 dark:text-zinc-400">{f.keys}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {activeManualTab === 'heatmap' && (
              <div className="flex flex-col gap-4">
                <span className="text-xs font-bold uppercase text-rose-600 dark:text-rose-400">Error Diagnostics</span>
                <h2 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100">Real-Time Error Heatmap Engine</h2>
            ...
            {activeManualTab === 'zen' && (
              <div className="flex flex-col gap-4">
                <span className="text-xs font-bold uppercase text-emerald-600 dark:text-emerald-400">Distraction-Free Practice</span>
                <h2 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100">Zen Mode & Focus Controls</h2>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
            ...
            {activeManualTab === 'analytics' && (
              <div className="flex flex-col gap-4">
                <span className="text-xs font-bold uppercase text-sky-600 dark:text-sky-400">AI Diagnostic Coach</span>
                <h2 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100">Contextual WPM Insights</h2>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
            ...
            {activeManualTab === 'formula' && (
              <div className="flex flex-col gap-4">
                <span className="text-xs font-bold uppercase text-amber-600 dark:text-amber-400">Calculation Standard</span>
                <h2 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100">Net WPM & Accuracy Formulas</h2>
                <div className="p-4 rounded-2xl bg-slate-900 dark:bg-zinc-950 border border-slate-800 dark:border-zinc-800 text-indigo-200 dark:text-indigo-300 font-mono text-xs space-y-2">
      ...
      {/* TAB 3: FAQ */}
      {mainTab === 'faq' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-100 dark:bg-indigo-950/60 text-indigo-800 dark:text-indigo-300 text-xs font-bold uppercase tracking-wide mb-2 border border-indigo-200/50 dark:border-indigo-800/50">
              <HelpCircle className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" />
              <span>Knowledge Base & Support</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-zinc-100">Frequently Asked Questions</h2>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 mt-1">Official standards, metric calculations, privacy safeguards, and verification procedures for Typerca.</p>
          </div>
            ...
            {faqs.map((faq, idx) => {
              ...
              return (
                <div
                  ...
                  className="p-5 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 cursor-pointer transition-all hover:bg-slate-100/80 dark:hover:bg-zinc-900 shadow-xs"
                >
                  <div className="flex items-center justify-between gap-3 font-extrabold text-slate-900 dark:text-zinc-100 text-sm">
                    <span>{faq.q}</span>
                    {isOpen ? <ChevronUp className="w-4 h-4 text-indigo-600 dark:text-indigo-400 shrink-0" /> : <ChevronDown className="w-4 h-4 text-slate-400 dark:text-zinc-500 shrink-0" />}
                  </div>
                  {isOpen && (
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 font-medium mt-3 pt-3 border-t border-slate-200 dark:border-zinc-800 leading-relaxed">
                      {faq.a}
                    </p>
                  )}
                </div>
      ...
      {/* TAB 4: ABOUT US */}
      {mainTab === 'about' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-10 text-slate-700 dark:text-zinc-300 leading-relaxed">
          
          <section className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-100 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 text-xs font-bold uppercase tracking-wide border border-indigo-200/50 dark:border-indigo-800/50">
              <Rocket className="w-3.5 h-3.5" />
              <span>Our Mission</span>
            </div>
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-zinc-100 leading-tight">
              Inspiring Millions to Master Keyboarding Speed & Precision
            </h2>
            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-indigo-950 via-zinc-950 to-indigo-950 text-white shadow-md relative overflow-hidden border border-indigo-900/40">
          ...
          <section className="p-6 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex flex-col md:flex-row gap-6 items-start md:items-center">
            <div className="w-16 h-16 rounded-2xl bg-indigo-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-indigo-600/30 font-black text-2xl">
              DT
            </div>
            <div className="space-y-1.5 flex-1">
              ...
              <h3 className="text-xl font-extrabold text-slate-900 dark:text-zinc-100">Drenchack Tech Company</h3>
          ...
          <section className="space-y-6 border-t border-slate-200 dark:border-zinc-800 pt-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                <h3 className="text-2xl font-extrabold text-slate-900 dark:text-zinc-100 flex items-center gap-2">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-indigo-950 via-zinc-950 to-black text-white shadow-xl border border-indigo-800/40 relative overflow-hidden flex flex-col md:flex-row items-center md:items-start gap-6">
      ...
      {mainTab === 'privacy' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-8 text-slate-700 dark:text-zinc-300 leading-relaxed">
          
          <header className="border-b border-slate-200 dark:border-zinc-800 pb-4 space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 text-xs font-bold uppercase tracking-wide border border-emerald-200/50 dark:border-emerald-800/50">
              <Lock className="w-3.5 h-3.5" />
              <span>AdSense, GDPR & CCPA Fully Compliant</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Privacy Policy</h2>
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400">Effective Date: August 2026 | Last Updated: August 21, 2026 | Entity: Drenchack Tech Company</p>
          </header>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
              ...
              <li><strong>User Opt-Out Controls:</strong> You have the absolute right to opt out of personalized interest-based advertising at any time by configuring your preferences at <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline font-semibold">Google Ads Settings</a> or through the industry-standard <a href="https://www.aboutads.info/choices" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline font-semibold">Digital Advertising Alliance (aboutads.info)</a> portal.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
              Typerca utilizes HTML5 <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-zinc-900 font-mono text-indigo-700 dark:text-indigo-300">localStorage</code> exclusively on your device to retain your customized user experience across sessions:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 my-2 text-xs">
              <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
                <strong className="block text-slate-900 dark:text-zinc-100 font-bold mb-1">Speed Performance</strong>
                <p className="text-slate-600 dark:text-zinc-400">Historical WPM scores, accuracy logs, test durations, and certificate hashes.</p>
              </div>
              <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
                <strong className="block text-slate-900 dark:text-zinc-100 font-bold mb-1">Ergonomic Diagnostics</strong>
                <p className="text-slate-600 dark:text-zinc-400">Key error frequencies used to generate your real-time visual error heatmap.</p>
              </div>
              <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
                <strong className="block text-slate-900 dark:text-zinc-100 font-bold mb-1">User Preferences</strong>
                <p className="text-slate-600 dark:text-zinc-400">Mechanical sound profile choice, volume levels, daily goals, and Zen Mode.</p>
              </div>
            </div>
          ...
          <section className="space-y-3 border-t border-slate-200 dark:border-zinc-800 pt-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">7. Privacy Inquiries & Data Protection Contact</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-xs space-y-1">
              <div><strong className="text-slate-800 dark:text-zinc-200">Entity:</strong> <span className="text-slate-600 dark:text-zinc-400">Drenchack Tech Company</span></div>
              <div><strong className="text-slate-800 dark:text-zinc-200">Lead Engineer:</strong> <span className="text-slate-600 dark:text-zinc-400">Philemon Osei Kusi</span></div>
              <div><strong className="text-slate-800 dark:text-zinc-200">Email:</strong> <a href="mailto:philemonkusi292@gmail.com" className="text-indigo-600 dark:text-indigo-400 font-mono font-bold hover:underline">philemonkusi292@gmail.com</a></div>
            </div>
          </section>
      ...
      {mainTab === 'terms' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-8 text-slate-700 dark:text-zinc-300 leading-relaxed">
          <header className="border-b border-slate-200 dark:border-zinc-800 pb-4 space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 text-xs font-bold uppercase tracking-wide border border-amber-200/50 dark:border-amber-800/50">
              <Scale className="w-3.5 h-3.5" />
              <span>Terms of Use & Service Agreement</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Terms of Service</h2>
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400">Effective Date: August 2026 | Drenchack Tech Company</p>
          </header>

          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">1. Acceptance of Terms & Conditions</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">2. Free Educational License & Usage Rights</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">3. Intellectual Property Rights</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">4. Disclaimer of Warranties & Limitation of Liability</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3 border-t border-slate-200 dark:border-zinc-800 pt-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">5. Governing Law & Jurisdiction</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
      ...
      {mainTab === 'disclaimer' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-8 text-slate-700 dark:text-zinc-300 leading-relaxed">
          <header className="border-b border-slate-200 dark:border-zinc-800 pb-4 space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-100 dark:bg-rose-950/60 text-rose-800 dark:text-rose-300 text-xs font-bold uppercase tracking-wide border border-rose-200/50 dark:border-rose-800/50">
              <AlertTriangle className="w-3.5 h-3.5" />
              <span>Legal & Ergonomic Disclaimer</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Website & Health Disclaimer</h2>
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400">Effective Date: August 2026 | Drenchack Tech Company</p>
          </header>

          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">1. General Educational Information Only</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">2. Ergonomic & Repetitive Strain Injury (RSI) Notice</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
            ...
            <div className="p-4 rounded-2xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/60 text-rose-900 dark:text-rose-300 text-xs font-semibold">
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">3. External Links & Third-Party Services</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
      ...
      {mainTab === 'cookies' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-8 text-slate-700 dark:text-zinc-300 leading-relaxed">
          <header className="border-b border-slate-200 dark:border-zinc-800 pb-4 space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-950/60 text-purple-800 dark:text-purple-300 text-xs font-bold uppercase tracking-wide border border-purple-200/50 dark:border-purple-800/50">
              <CookieIcon className="w-3.5 h-3.5" />
              <span>Transparent Storage Disclosures</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Cookie & Storage Policy</h2>
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400">Effective Date: August 2026 | Drenchack Tech Company</p>
          </header>

          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">1. Understanding Cookies & Local Storage Technologies</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
              This Cookie Policy explains how Typerca ("we", "us", "our") utilizes cookies, web beacons, and browser HTML5 local storage technologies when you visit our website at <span className="font-mono text-indigo-600 dark:text-indigo-400 font-semibold">https://typerca.vercel.app/</span>.
            </p>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
            ...
            <div className="overflow-x-auto my-4">
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                <thead>
                  <tr className="border-b border-slate-300 dark:border-zinc-800 bg-slate-100 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 font-bold">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-zinc-800">
                  <tr>
                    <td className="p-3 font-bold text-slate-800 dark:text-zinc-200">Essential App State</td>
                    <td className="p-3 font-mono text-indigo-700 dark:text-indigo-400">HTML5 LocalStorage</td>
                    <td className="p-3 text-slate-600 dark:text-zinc-400">Stores test history, WPM records, username, sound volume, theme, and completed challenges.</td>
                    <td className="p-3 font-semibold text-slate-800 dark:text-zinc-200">Persistent (Client Controlled)</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-bold text-emerald-800 dark:text-emerald-400">User Consent</td>
                    <td className="p-3 font-mono text-indigo-700 dark:text-indigo-400">Cookie: typerca_consent</td>
                    <td className="p-3 text-slate-600 dark:text-zinc-400">Records your cookie banner consent decision (accepted or customized).</td>
                    <td className="p-3 text-slate-800 dark:text-zinc-200">12 Months</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-bold text-indigo-700 dark:text-indigo-400">Advertising & Diagnostics</td>
                    <td className="p-3 font-mono text-indigo-700 dark:text-indigo-400">Google AdSense / DART</td>
                    <td className="p-3 text-slate-600 dark:text-zinc-400">Delivers relevant, non-intrusive advertisements to finance free worldwide platform access.</td>
                    <td className="p-3 text-slate-800 dark:text-zinc-200">Up to 13 Months</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="space-y-3">
            <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">2. How You Can Manage or Block Cookies</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3 border-t border-slate-200 dark:border-zinc-800 pt-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">3. Contacting the Policy Team</h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
              If you have any questions about our use of cookies or tracking technologies, please write to us at <a href="mailto:philemonkusi292@gmail.com" className="text-indigo-600 dark:text-indigo-400 font-mono font-bold hover:underline">philemonkusi292@gmail.com</a>.
            </p>
          </section>
        </div>
      )}
      ...
      {mainTab === 'contact' && (
        <div className="p-6 sm:p-10 rounded-3xl bg-white/80 dark:bg-black border border-slate-200/60 dark:border-zinc-800 shadow-sm flex flex-col gap-8 text-slate-700 dark:text-zinc-300 leading-relaxed">
          <header className="border-b border-slate-200 dark:border-zinc-800 pb-4 space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-100 dark:bg-sky-950/60 text-sky-800 dark:text-sky-300 text-xs font-bold uppercase tracking-wide border border-sky-200/50 dark:border-sky-800/50">
              <Mail className="w-3.5 h-3.5" />
              <span>Direct Support</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Contact Us</h2>
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400">Reach the engineering and support team at Drenchack Tech Company</p>
          </header>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Direct Inquiries</h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 space-y-3 text-xs">
                <div>
                  <strong className="block text-slate-800 dark:text-zinc-200">Organization:</strong>
                  <span className="text-slate-600 dark:text-zinc-400">Drenchack Tech Company</span>
                </div>
                <div>
                  <strong className="block text-slate-800 dark:text-zinc-200">Lead Engineer:</strong>
                  <span className="text-slate-600 dark:text-zinc-400">Philemon Osei Kusi</span>
                </div>
                <div>
                  <strong className="block text-slate-800 dark:text-zinc-200">Email:</strong>
                  <a href="mailto:philemonkusi292@gmail.com" className="text-indigo-600 dark:text-indigo-400 font-mono font-bold hover:underline">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800">
              {contactSent ? (
                <div className="p-6 text-center flex flex-col items-center gap-4 animate-in fade-in duration-300">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-600 to-violet-500 text-white flex items-center justify-center shadow-lg shadow-indigo-600/30">
                    <CheckCircle2 className="w-8 h-8" />
                  </div>

                  <div className="space-y-1.5 max-w-sm">
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 text-[11px] font-bold uppercase tracking-wider border border-emerald-200/50 dark:border-emerald-800/50">
                      <Clock className="w-3 h-3 text-emerald-700 dark:text-emerald-400" />
                      Priority Response Guaranteed
                    </span>
                    <h4 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-zinc-100">
                  ...
                  <button
                    ...
                    className="mt-2 px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-600/30 transition-all cursor-pointer"
                  >
                    Send Another Note
                  </button>
                </div>
                ...
                <form onSubmit={handleContactSubmit} className="space-y-3.5">
                  {contactError && (
                    <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-900/60 text-rose-700 dark:text-rose-300 text-xs font-semibold flex items-center gap-2 animate-in fade-in">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-black border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-600 text-xs font-medium focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-zinc-300 mb-1">Your Email *</label>
                    <input
                      type="email"
                      required
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-zinc-300 mb-1">Topic</label>
                    <select
                      value={contactSubject}
                      onChange={(e) => setContactSubject(e.target.value)}
                      className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-black border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 text-xs font-medium focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-black border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-600 text-xs font-medium focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-600/30 flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 active:scale-98 cursor-pointer"
                  >
                    {contactSubmitting ? (
                      <>
