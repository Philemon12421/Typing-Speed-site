...
import { Keyboard, BarChart2, Flame, Trophy, Target, Volume2, VolumeX, Sliders, Award, BookOpen, Swords } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems: { id: TabType; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'duel', label: 'Live Duel', icon: <Swords className="w-4 h-4 text-indigo-600" /> },
